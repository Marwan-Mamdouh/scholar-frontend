...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex min-h-21.5 w-full flex-col bg-neutral-900/50 px-6 py-6 backdrop-blur-[7.5px] sm:px-10 lg:h-21.5 lg:flex-row lg:items-center lg:justify-between lg:px-26 lg:py-3.5">
