...
const ToolsHero = ({
  ...
  return (
    <section className="relative pt-28 pb-14 lg:pt-32">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-y-0 left-1/2 w-screen -translate-x-1/2 overflow-hidden border-b border-neutral-700 bg-brand-gradient"
      >
      ...
      <div className="relative z-10 grid items-end gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-14">
        <div>
          <p
