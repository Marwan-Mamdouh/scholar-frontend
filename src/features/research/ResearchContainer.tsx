...
const RESEARCH_DATA: Record<TabType, ResearchInfoCardProps> = {
  researchers: {
    ...
    description: "Browse academic profiles, research areas, and publications to find experts in your field",
    stats: [
  ...
  papers: {
    ...
    description: "Discover ground-breaking academic papers and research across various disciplines",
    stats: [
  ...
  projects: {
    ...
    description: "Find real-world research projects and collaborative initiatives worldwide",
    stats: [
