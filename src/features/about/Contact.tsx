    ...
    <section>
      <div className="rounded-3xl bg-neutral-50/5 shadow-[0px_2px_5px_0px_#70B5DF] py-10.5 px-6 lg:px-17.5 flex flex-col gap-6 lg:flex-row">
        ...
        <div className="space-y-2.5">
          ...
          />
          <h2 className="font-medium text-4xl leading-12.5 capitalize text-neutral-50">
            Start a Conversation
          </h2>
          <p className="font-light text-base leading-6 lowercase text-neutral-100 lg:max-w-120">
