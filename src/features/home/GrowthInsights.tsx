...
const GrowthInsights = ({ stats }: GrowthInsightsProps) => {
  return (
    <div className="relative w-full flex justify-center my-2.5">
      {/* Glow */}
      <div className="hidden lg:block absolute -left-20 top-1/2 -translate-y-1/2 w-71.75 h-50 pointer-events-none">
      ...
      <div className="relative bg-brand-gradient z-10 backdrop-blur-[10px] rounded-3xl flex flex-col items-center py-8 w-95 lg:flex-row lg:items-center lg:gap-17.75 lg:px-9.5 lg:py-6.5 lg:w-215.25 lg:h-33.5">
        ...
        <div className="flex flex-col items-center lg:items-start shrink-0">
          <span className="font-[kadwa] font-bold tracking-[0.10em] capitalize text-accent-400 text-[16px] lg:text-[20px]">
            Powered By Innovation
          </span>
          <span className="font-[kanit] font-semibold tracking-[0.05em] capitalize text-neutral-50 text-[36px] lg:text-[40px]">
            Growth Insights
          </span>
        </div>
